...
trait ApiResponse
{
     ...
     * @return JsonResponse
     */
    protected function successResponse(array $data, HttpStatus $httpStatus = HttpStatus::HTTP_OK, ?string $message = null): JsonResponse
    {
        $response = [
            'status' => 'success',
            'data' => $data,
     ...
     * @return JsonResponse
     */
    protected function successResponseWithMeta(array $data, array $meta, HttpStatus $httpStatus = HttpStatus::HTTP_OK): JsonResponse
    {
        return response()->json(
            [
                'status' => 'success',
